...
books=pd.read_csv('C:\\Users\\Manjunath\\Desktop\\Major project\\AI Assistant\\csv files\\BX-Books.csv',sep=";",error_bad_lines=False,warn_bad_lines=False,encoding='latin-1')
...
users=pd.read_csv('C:\\Users\\Manjunath\\Desktop\\Major project\\AI Assistant\\csv files\\BX-Users.csv',sep=";",error_bad_lines=False,warn_bad_lines=False,encoding='latin-1')
ratings=pd.read_csv('C:\\Users\\Manjunath\\Desktop\\Major project\\AI Assistant\\csv files\\BX-Book-Ratings.csv',sep=";",error_bad_lines=False,warn_bad_lines=False,encoding='latin-1')
...
movies=pd.read_csv(r'C:\\Users\\Manjunath\\Desktop\\Major project\\AI Assistant\\csv files\\movies.csv')
ratings=pd.read_csv(r'C:\\Users\\Manjunath\\Desktop\\Major project\\AI Assistant\\csv files\\ratings.csv')
...
def playSong(final_emotion):
    ...
    path = "C:\\Users\\Manjunath\\Desktop\\Major project\\AI Assistant\\songs\\"+final_emotion+"\\"+song
...
def query():
    while True:
        ...
        if'wikipedia' in query:
            ...
            music_dir= r'C:\Users\CHANDANA CHANGOMULA\Music'
